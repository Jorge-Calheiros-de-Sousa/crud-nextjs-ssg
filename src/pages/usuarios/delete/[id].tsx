...
export default function Excluir({ user }: { user: User }) {
            ...
            <Main>
                ...
                <form className={styles.form} action={"#"}>
                    ...
                    <div style={{
                        ...
                        <div className={styles.btn} onClick={handleSubmit} style={{ backgroundColor: 'red', color: "white", marginRight: 10, cursor: "pointer" }}>
                            Excluir
                        </div>
                        <Link href={"/usuarios"}>
